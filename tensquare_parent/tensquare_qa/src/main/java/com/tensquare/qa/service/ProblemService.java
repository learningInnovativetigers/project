...
public class ProblemService {
     ...
     * @return
     */
    public Page<Problem> findNewProListByLabelId(String labelId, int page, int size) {
        PageRequest pr = PageRequest.of(page - 1, size);      // 不要忘记减一
        return problemDao.findNewProListByLabelId(labelId, pr);
    }
